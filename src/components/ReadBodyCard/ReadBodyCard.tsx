...
const ReadBodyCard = () => {
  ...
  const [mode, setMode]: any = useState(
    mylocalStorage ? mylocalStorage : "light"
  );
  useEffect(() => {
    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 ">
          ...
          <p className="text-[#2B9E76] text-[15px] font-semibold">১</p>
        </div>
        <div>
          <p className=" text-right text-[20px] my-6 leading-[40px] font-[300]">
          ...
          <p className="text-[12px] text-[#2B9E76] my-6">
            ‘আলক্বামাহ ইব্‌নু ওয়াক্কাস আল-লায়সী (রহঃ) থেকে বর্ণিত:
          </p>
          <p className="text-[12px] my-6 leading-[30px]">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <p className="text-[12px]">হাদিসের মান :</p>
            <p className="text-[12px] p-[7px] bg-[#2B9E76] rounded-lg text-white cursor-pointer">
              সহিহ হাদিস
            </p>
          </div>
